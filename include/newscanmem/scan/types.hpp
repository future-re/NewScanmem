...
enum class ScanDataType : std::uint8_t {
...
enum class ScanMatchType : std::uint8_t {
...
constexpr auto matchNeedsUserValue(ScanMatchType scanMatchType) noexcept
    -> bool {
...
// logic)
[[nodiscard]] constexpr auto bytesNeededForType(ScanDataType dataType)
    -> std::size_t {
    switch (dataType) {
        case ScanDataType::INTEGER_8:
            return 1;
