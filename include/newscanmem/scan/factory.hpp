 ...
 */
[[nodiscard]] auto makeScanRoutine(ScanDataType data_type, ScanMatchType match_type,
                                   bool reverse_endianness) -> ScanRoutine;

/**
 * @brief Check if a scan routine is available for the given configuration
 */
[[nodiscard]] auto isRoutineAvailable(ScanDataType data_type, ScanMatchType match_type) -> bool;
