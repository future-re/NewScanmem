...
[[nodiscard]] auto prepareScanRoutine(const ScanOptions& opts, const UserValue* user_value)
    -> std::expected<ScanRoutine, std::string>;

[[nodiscard]] auto scanWindowSize(const ScanOptions& opts, const UserValue* user_value) -> std::size_t;
