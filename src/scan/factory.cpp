...
auto makeScanRoutine(const ScanDataType type, const ScanMatchType match,
                     const bool reverse_endianness) -> ScanRoutine {
    switch (type) {
        ...
        case ScanDataType::FLOAT_32:
            return makeNumericScanRoutine<float>(match, reverse_endianness);
        case ScanDataType::FLOAT_64:
            return makeNumericScanRoutine<double>(match, reverse_endianness);
        ...
        case ScanDataType::ANY_INTEGER:
            return makeAnyIntegerScanRoutine(match, reverse_endianness);
        case ScanDataType::ANY_FLOAT:
            return makeAnyFloatScanRoutine(match, reverse_endianness);
        case ScanDataType::ANY_NUMBER:
            return makeAnyNumberScanRoutine(match, reverse_endianness);
        default:
            return nullRoutine();
    }
}
